...
Fitur:
🔹 Login / Register (SSO/Email) V
🔹 Dashboard Dosen: melihat status semua surat tugas (Diajukan, Diproses, Disetujui, Ditolak). - Royce
//🔹 Pilih jenis kegiatan (Surat Tugas /Assesor BKD)
🔹 Ajukan Surat Tugas: isi form (tujuan, tanggal kegiatan, tempat, lampirkan surat undangan). V
🔹 Lihat Riwayat Surat Tugas - Royce
🔹 Download Surat Tugas yang Disetujui (PDF) - Eric
...
Fitur:
🔹 Lihat daftar pengajuan surat tugas dari dosen di prodi-nya - Royce
🔹 Review & ACC / Tolak permohonan - Royce
//🔹 Pilih jenis kegiatan (Surat Tugas /Assesor BKD)
🔹 Ajukan Surat Tugas : isi form (tujuan, tanggal kegiatan, tempat, lampirkan surat undangan). V
🔹 Tambahkan catatan/revisi jika ditolak -Royce
🔹 Histori keputusan - 
🔹 Forward otomatis ke Dekan setelah ACC - Eric
...
Fitur:
🔹 Lihat daftar pengajuan surat tugas dari prodi di bawah fakultasnya - ROyce
🔹 ACC / Tolak surat tugas - Royce
//🔹 Pilih jenis kegiatan  (Surat Tugas /Assesor BKD)
🔹 Dapat membuat surat tugas sendiri (khusus Dekan) → diarahkan langsung ke Rektor untuk tanda tangan, tetapi tetap melalui verifikasi Sekretaris terlebih dahulu. V
🔹 Memberikan tanda tangan digital setelah surat tugas dibuat oleh Sekretaris. - Hansen
...
Fitur Utama:
🔹Melihat daftar surat tugas yang sudah disetujui oleh Dekan. - Royce
🔹Generate surat tugas berdasarkan jenis kegiatan yang dipilih oleh dosen pada form pengajuan (Surat Tugas Biasa{narasumber, peserta, pembicara, dll} / Surat Tugas Assesor BKD) - Eric
🔹Edit Data Surat: Bisa melakukan edit atau perbaikan isi surat tugas dari hasil form dosen sebelum di-generate menjadi PDF final. - Erick
🔹Generate Surat Tugas (PDF): - Eric
...
🔹Laporan surat tugas, surat masuk, surat keluar per bulan / fakultas / dosen dalam bentuk diagram / statistic - Royce
...
🔹 Memberikan tanda tangan digital (QR Code/eSign). - Hansen
...
🔹 Validasi & Stempel Digital (upload versi final + QR Code tanda tangan) - Hansen
🔹 Upload versi final surat tugas yang sudah distempel ke sistem arsip (Google Drive API). - Hansen
...
Fitur:
🔹 CRUD akun pengguna. - Erick
🔹 Manajemen role & permission (Spatie Laravel Permission). - Erick
