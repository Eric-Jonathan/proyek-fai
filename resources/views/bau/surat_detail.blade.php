...
@section('title', 'Detail Surat Tugas BAU')
...
<div class="container py-4">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('bau.dashboard') }}" class="btn btn-outline-secondary">
        ...
        <div class="card-body p-4">
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <p class="mb-1">
                        <strong>Status Stempel:</strong>
                        <span class="badge bg-secondary text-white">Belum Distempel</span>
                    </p>
                </div>
            </div>
